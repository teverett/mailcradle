...
public class IMAPMessageData {
   ...
   /*
    * get the message body <p>reading the message body has the effect of marking the message read. That is a bit inconvenient, so we read the flag and reset it to what it was</p>
    */
